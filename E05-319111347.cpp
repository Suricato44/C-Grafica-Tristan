...
Model Goddard_Pata_Der_Del;
Model Goddard_Pata_Der_Tra;
Model Goddard_Pata_Izq_Del;
Model Goddard_Pata_Izq_Tra;
...
int main()
{
	...
	Goddard_Pata_Der_Del = Model();
	Goddard_Pata_Der_Del.LoadModel("Models/goddard_PataDerDel.obj");

	Goddard_Pata_Der_Tra = Model();
	Goddard_Pata_Der_Tra.LoadModel("Models/goddard_PataDerTra.obj");

	Goddard_Pata_Izq_Del = Model();
	Goddard_Pata_Izq_Del.LoadModel("Models/goddard_PataIzqDel.obj");

	Goddard_Pata_Izq_Tra = Model();
	Goddard_Pata_Izq_Tra.LoadModel("Models/goddard_PataIzqTra.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.4f, -0.2f, 0.7f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		Goddard_Pata_Der_Del.RenderModel();


		// pata delantera izquierda
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.4f, -0.4f, -0.7f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		Goddard_Pata_Izq_Del.RenderModel();
		//pata trasera derecha
		model = modelaux;

		model = glm::translate(model, glm::vec3(-0.1f, -1.0f, 0.7f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		Goddard_Pata_Der_Tra.RenderModel();
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		Goddard_Pata_Izq_Tra.RenderModel();
