...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// ----------- Ojos
		model = glm::translate(model, glm::vec3(-0.8f, 2.1f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.2f, 1.2f, 3.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.75f, 0.75f, 0.75f);
		...
		// ----------- Oreja Izquierda Articulacion
		model = modelaux; //Hereda las traslaciones
		model = glm::translate(model, glm::vec3(-2.2f, 0.5f, 1.5f));
		...
		model = glm::translate(model, glm::vec3(2.7f, -0.4f, 3.01f));
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(2.4f, 1.4f, 1.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.75f, 0.75f, 0.75f);
		...
		model = glm::translate(model, glm::vec3(1.45f, 0.0f, -0.4f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.5f, 1.4f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		...
		model = modelauxCuerpo;
		model = glm::translate(model, glm::vec3(2.7f, -0.4f, -3.00f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		// ========================================== COLA ==========================================
		model = modelauxCuerpo;
		model = glm::translate(model, glm::vec3(-5.25f, 0.00f, 0.00f));
		...
		model = modelauxLlantas;
		model = glm::translate(model, glm::vec3(2.0f, -2.0f, 2.51f));
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
